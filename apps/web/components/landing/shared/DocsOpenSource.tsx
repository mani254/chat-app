    ...
    <>
      ...
      <section id="docs" className="py-20 md:py-32 bg-background-accent/30">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-primary">Comprehensive Documentation</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            >
              ...
              <Link href="/docs/quickstart" className="text-primary hover:underline text-sm font-medium">
                Read Guide →
              </Link>
            </motion.div>
            ...
            >
              ...
              <Link href="/docs/api" className="text-primary hover:underline text-sm font-medium">
                View API →
              </Link>
            </motion.div>
            ...
            >
              ...
              <Link href="/docs/security" className="text-primary hover:underline text-sm font-medium">
                Learn More →
              </Link>
            </motion.div>
          </div>
