import { fetchMessages } from '@/lib/messagApi';
...
interface MessageState {
  ...
  loadMessages: (params: { chatId: string; reset?: boolean; limit?: number }) => Promise<void>;
    ...
    (set, get) => ({
      ...
      loadMessages: async ({ chatId, reset = false, limit }) => {
        ...
        try {
          ...
          set((state) => ({
            messages: reset ? orderedMessages : [...orderedMessages, ...state.messages],
            limit: fetchLimit,
